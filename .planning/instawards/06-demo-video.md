...
## Acceptance criteria
- [ ] Both videos recorded, watchable (hosted link: Loom/YouTube/Drive).
- [ ] CLI video shows real testnet tx confirmations.
- [ ] Links recorded in `06-evidence.md`.
